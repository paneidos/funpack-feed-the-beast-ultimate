...
$build_dir = File.expand_path("~/funpacks/ftb-ultimate/build")
$cache_dir = File.expand_path("~/funpacks/ftb-ultimate/cache")
$working_dir = File.expand_path(ENV['WORKING'] || "~/funpacks/ftb-ultimate/working")
